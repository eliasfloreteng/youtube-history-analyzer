...
import { formatSessionDuration, formatWatchTimeHours } from "@/lib/session-analysis"
import type { SessionAnalysisResult } from "@/lib/session-analysis"
import { Clock, Calendar, PlayCircle, Zap, Timer } from "lucide-react"
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatWatchTimeHours(totalWatchTimeHours)}</div>
          <p className="text-xs text-muted-foreground">Total time spent in watching sessions</p>
        </CardContent>
      </Card>
